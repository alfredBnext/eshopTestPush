...
public class FirebaseInstance extends FirebaseMessagingService {
    ...
    public void onNewToken(String s) {
        Log.e("NEW_TOKEN", s);
        // TODO: Add handler so when the new device token is generated, it is passed to Marketing Cloud.
        SFMCSdk.requestSdk(
                (sdk) -> sdk.mp(
    ...
    public void onMessageReceived(final RemoteMessage remoteMessage) {
        // TODO: Add handler for Marketing Cloud, so when two Push services are used the message is distributed by the correct SDK.
